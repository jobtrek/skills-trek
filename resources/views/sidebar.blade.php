...
<aside id="logo-sidebar" class=" w-96 min-h-screen border-r" aria-label="Sidebar">
    ...
    <div class="h-full px-10 pb-4 overflow-y-auto bg-white">
        <ul class="space-y-4 font-medium">
            <li>
                <a href="/" class="flex items-center p-2 text-gray-500 rounded-lg dark:hover:bg-black dark:hover:text-white group">
                    ...
                    <span class="text-2xl ms-3">Home</span>
                </a>
            </li>
            <li>
                <a href="#" class="flex items-center p-2 text-gray-500 rounded-lg dark:hover:bg-black dark:hover:text-white group">
            ...
            <li>
                <a href="#" class="flex items-center p-2 text-gray-500 rounded-lg dark:hover:bg-black dark:hover:text-white group">
                    ...
                    <span class="flex-1 text-2xl ms-3 whitespace-nowrap">Users</span>
                </a>
            </li>
            <li>
